"""
Concrete ``RuleEngine`` class — pattern compilation, contradiction checks,
overrides, and application.
"""
...
from .application import _RuleEngineApplication
from .constants import MEDIA, SLEEVE, _HARD_PATTERN_KEYS, _SOFT_PATTERN_KEYS
from .contradiction import _RuleEngineContradiction
from .overrides import _RuleEngineOverrides

logger = logging.getLogger(__name__)


class _RuleEnginePatterns:
...
class RuleEngine(
    _RuleEnginePatterns,
    _RuleEngineContradiction,
    _RuleEngineOverrides,
    _RuleEngineApplication,
):
    """
